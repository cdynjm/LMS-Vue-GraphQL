import{d as T,r as x,p as I,q as V,c as p,o,a,b as l,w as s,u as t,m as B,J as R,e as g,P as Q,g as v,h as C,F as y,i as $,t as i,n as D,j as O}from"./app-CtoEL4a4.js";import{_ as h}from"./index-iWvz-iZK.js";import{_ as W}from"./NavFooter.vue_vue_type_script_setup_true_lang-CwG4qb4N.js";import{a as z,b as J,_ as K}from"./CardHeader.vue_vue_type_script_setup_true_lang-C1WsUdX_.js";import{_ as G}from"./CardDescription.vue_vue_type_script_setup_true_lang-D5aqi_BH.js";import{_ as H,a as U,b,c,d as X,e as u}from"./TableHeader.vue_vue_type_script_setup_true_lang-DCJtF_Cq.js";import{u as Y,a as Z}from"./useQuery-CZXxaNs8.js";import{L as ee}from"./loader-circle-2RTmvAxL.js";import{C as te}from"./circle-minus-ngeSbBYN.js";import{F as ae,A as se,a as le}from"./file-text-C3G-3P1G.js";const ne={class:"flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8"},re={class:"not-has-[nav]:hidden mb-6 w-full lg:px-40"},oe={class:"flex items-center justify-between gap-4 w-full"},ie={class:"flex items-center gap-4"},ue={class:"min-h-screen flex flex-col w-full"},de={class:"flex-1 w-full lg:px-40 lg:pt-10"},ce={class:"text-green-500 flex items-center justify-center"},fe={class:"text-red-500 flex items-center justify-center"},me=["href"],pe={class:"text-wrap text-[13px]"},ge={class:"text-nowrap"},_e={class:"text-nowrap"},xe={class:"text-nowrap"},ve={key:0},be={class:"flex justify-between items-center mt-8"},Ne=T({__name:"Welcome",setup(we){Y();const f=x(1),F=x(""),P=x([]),d=x({currentPage:1,lastPage:1,hasMorePages:!1}),N=async()=>(await O.post("/graphql",{query:`
