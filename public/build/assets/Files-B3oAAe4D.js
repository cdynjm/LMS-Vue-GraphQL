import{a as I,_ as H}from"./AppLayout.vue_vue_type_script_setup_true_lang-C5CFA1ak.js";import{d as J,r as h,p as W,c as o,o as n,a as t,u as e,m as X,w as a,b as s,h as Z,e as d,t as r,g as p,F as v,i as w,n as A,j as ee}from"./app-BtIiNK6n.js";import{_ as T,d as B,a as O,c as Q,b as te}from"./CardTitle.vue_vue_type_script_setup_true_lang-CFmexVLH.js";import{_ as se,C as E,a as ae}from"./SkeletonBox.vue_vue_type_script_setup_true_lang-DqgW14hw.js";import{_ as le,a as ie,b as $,c as S,d as ne,e as _,f as re}from"./Skeleton.vue_vue_type_script_setup_true_lang-CSonJTR7.js";import{_ as q}from"./index-BlDsTxcc.js";import{_ as oe}from"./Input.vue_vue_type_script_setup_true_lang-BccWLCjR.js";import{u as de,a as ue,C as k}from"./Skeleton.vue_vue_type_script_setup_true_lang-BXdcxpuC.js";import{_ as M,F as ce}from"./SkeletonCard.vue_vue_type_script_setup_true_lang-Bg1gbc96.js";import{S as fe,_ as me}from"./Pagination.vue_vue_type_script_setup_true_lang-HPyGJ_5K.js";import{F as R}from"./NavFooter.vue_vue_type_script_setup_true_lang-Bx6pGu5B.js";import{L as pe}from"./loader-circle-Upe7h6fc.js";import{F as _e}from"./file-pen-line-GBDsgjRx.js";import{E as ge}from"./eye-rkiB695v.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-DgkK8klM.js";const xe={class:"p-4 space-y-6"},he={class:"flex w-full justify-between items-center"},ve={key:0},ye={key:1},be={class:"flex text-md font-bold items-center"},we={class:"flex items-center gap-2 w-full sm:w-auto"},$e={class:"text-center text-red-500 flex items-center justify-center"},Se={class:"flex items-center space-x-3"},ke={class:"font-medium"},Pe={class:"flex flex-wrap items-center justify-between gap-4"},Fe={class:"flex text-md font-bold items-center"},Ce={key:0,class:"grid grid-cols-1 gap-4"},De={class:"grid grid-cols-1 xl:grid-cols-3 gap-4"},Ne={class:"flex items-center space-x-4 rounded-md border p-4"},Le=["src"],Te={class:"flex-1 space-y-1"},qe={class:"text-sm font-medium leading-none"},je={class:"text-[13px] text-muted-foreground"},Ve={class:"text-[14px]"},Ie={class:"mb-4 grid grid-cols-[25px_minmax(0,1fr)] items-start pb-0 last:mb-0 last:pb-0"},Ae={class:"space-y-1"},Be={class:"text-sm font-medium leading-none"},Oe={class:"text-[12px] text-muted-foreground"},Qe={class:"text-gray-500 text-[13px] flex items-center gap-2"},Ee={key:0},Me={key:1},Re={class:"text-gray-500 text-[13px] flex items-center gap-2"},Ue={key:0},Ke={key:1},ze={class:"text-gray-500"},Ye=["href"];function U(P){const g=new Date(P),F=g.toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}),C=g.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0});return`${F} | ${C}`}const ct=J({__name:"Files",props:{id:{}},setup(P){const g=P,F=de(),C=[{title:"Files",href:"/admin/files/"+g.id}],c=h(1),D=h([]),y=h({currentPage:1,lastPage:1,hasMorePages:!1}),K=async()=>(await ee.post("/graphql",{query:`
