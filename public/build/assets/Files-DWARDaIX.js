import{F as q,_ as K}from"./AppLayout.vue_vue_type_script_setup_true_lang-dqe_YIKF.js";import{d as O,r as b,q as G,s as H,c as g,o,a as t,u as e,m as J,w as l,b as s,h as V,e as C,t as i,g as x,F as k,i as L,n as j,W as X,j as Y}from"./app-B1wYHys8.js";import{_ as I,a as B,b as m,c as d,d as E,e as r,f as M}from"./Skeleton.vue_vue_type_script_setup_true_lang-BT3JAgY4.js";import{_ as N}from"./index-DZEPmnre.js";import{_ as Z}from"./Input.vue_vue_type_script_setup_true_lang-C-eBUojE.js";import{u as ee,a as te,C as R}from"./Skeleton.vue_vue_type_script_setup_true_lang-DFYDqr58.js";import{F as le}from"./file-text-CqvvC73H.js";import{E as ae}from"./eye-C7XJFHb_.js";import{A as se,a as ne}from"./arrow-right-BwXlo2LI.js";import"./NavFooter.vue_vue_type_script_setup_true_lang-B80LdtZ9.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-CDIs3UvA.js";const re={class:"p-6 space-y-6"},ie={class:"flex w-full justify-between items-center"},ue={key:0},oe={class:"flex text-md font-bold items-center"},de={class:"text-center text-red-500 flex items-center justify-center"},fe=["onClick"],ce={class:"flex items-center space-x-3"},me={class:"font-medium"},pe={class:"flex items-center justify-between space-x-4"},_e={class:"text-red-500 flex items-center justify-center"},ge=["href"],ve=["onClick"],xe={class:"text-wrap text-[13px]"},ye={class:"text-nowrap"},we={class:"text-nowrap"},he={class:"text-nowrap"},be={key:0},Ce=["onClick"],ke={class:"flex justify-between items-center mt-8"};function Pe(P){const y=new Date(P),$=y.toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}),c=y.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0});return`${$} | ${c}`}const Ee=O({__name:"Files",props:{id:{}},setup(P){const y=P;ee();const $=[{title:"Files",href:"/user/files/"+y.id}],c=b(1),F=b(""),A=b([]),p=b({currentPage:1,lastPage:1,hasMorePages:!1}),Q=async()=>(await Y.post("/graphql",{query:`
