import{d as T,r as x,p as I,q as V,c as p,o,a,b as l,w as s,u as t,m as B,J as R,e as g,P as Q,g as v,h as C,F as y,i as $,t as i,n as D,j as O}from"./app-DYaLtrJX.js";import{_ as h}from"./index-HvcNzELA.js";import{_ as W}from"./NavFooter.vue_vue_type_script_setup_true_lang-2pQopk7O.js";import{a as z,b as J,_ as K}from"./CardHeader.vue_vue_type_script_setup_true_lang-DCeLXYRN.js";import{_ as G}from"./CardDescription.vue_vue_type_script_setup_true_lang-BGjCg-xD.js";import{_ as H,a as U,b,c,d as X,e as u}from"./TableHeader.vue_vue_type_script_setup_true_lang-f0GKZC2X.js";import{u as Y,a as Z}from"./useQuery-CwIaj24_.js";import{L as ee}from"./loader-circle-CVuoAwES.js";import{C as te}from"./circle-minus-C79GzVCH.js";import{F as ae,A as se,a as le}from"./file-text-D5_7dmA-.js";const ne={class:"flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8"},re={class:"not-has-[nav]:hidden mb-6 w-full lg:px-40"},oe={class:"flex items-center justify-between gap-4 w-full"},ie={class:"flex items-center gap-4"},ue={class:"min-h-screen flex flex-col w-full"},de={class:"flex-1 w-full lg:px-40 lg:pt-10"},ce={class:"text-green-500 flex items-center justify-center"},fe={class:"text-red-500 flex items-center justify-center"},me=["href"],pe={class:"text-wrap text-[13px]"},ge={class:"text-nowrap"},_e={class:"text-nowrap"},xe={class:"text-nowrap"},ve={key:0},be={class:"flex justify-between items-center mt-8"},Ne=T({__name:"Welcome",setup(we){Y();const f=x(1),F=x(""),P=x([]),d=x({currentPage:1,lastPage:1,hasMorePages:!1}),N=async()=>(await O.post("/graphql",{query:`
