import{_ as ae}from"./AppLayout.vue_vue_type_script_setup_true_lang-BCNtYKKV.js";import{d as ee,c,o as d,n as y,u as e,y as ne,a as s,m as re,w as o,b as t,g as oe,h as de,e as a,t as n,F as K,i as ce,j as pe}from"./app-D4JecN_R.js";import{_ as ue,a as fe,b as xe,c as me}from"./CardTitle.vue_vue_type_script_setup_true_lang-B4Tr132r.js";import{_ as Y}from"./CardDescription.vue_vue_type_script_setup_true_lang-DdlvriaV.js";import{c as ve,_ as ge}from"./index-CQpZrN1b.js";import{u as ye,a as he}from"./useQuery-XE_DLyZc.js";import{C as G}from"./circle-minus-CVUwNas2.js";import{c as f}from"./AppLogoIcon.vue_vue_type_script_setup_true_lang-DUC_AltH.js";import"./NavFooter.vue_vue_type_script_setup_true_lang-B15V8BqJ.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _e=f("UsersRoundIcon",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),Fe=ee({__name:"CardFooter",props:{class:{}},setup(x){const v=x;return(g,h)=>(d(),c("div",{"data-slot":"card-footer",class:y(e(ve)("flex items-center px-6 [.border-t]:pt-6",v.class))},[ne(g.$slots,"default")],2))}}),be={class:"p-6 space-y-6"},ke={class:"mt-6"},De={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Se={key:0},Ce={key:1},Me={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Re={key:0},$e={key:1},Ve={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},qe={class:"font-bold"},Ae={class:"mb-6"},Le={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ne={class:"text-[13px] text-gray-500 ml-10"},Pe={class:"flex items-center gap-2 mb-1"},Be={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-3 mt-6"},Ie={class:"text-gray-500 text-[13px]"},Te={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},je={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},ze={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Oe={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ue={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ee={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},He={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Qe={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ze={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ke=["href"];function u(x){return`${new Date(x).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}`}const nt=ee({__name:"View-File",props:{id:{}},setup(x){ye();const v=[{title:"View File",href:"/admin/view-file"}],g=x,h=async()=>(await pe.post("/graphql",{query:`
    query ($id: String!) {
        viewFile(id: $id) {
            file {
                municipalStatus
