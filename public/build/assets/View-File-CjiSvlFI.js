import{_ as oe}from"./AppLayout.vue_vue_type_script_setup_true_lang-hYxy-1el.js";import{d as _,c,o as d,n as g,u as e,y as de,F as y,b as t,a as i,m as ce,w as o,g as J,e as a,t as n,i as pe,j as ue}from"./app-Bzxxwo2w.js";import{_ as W,a as X,b as fe}from"./CardHeader.vue_vue_type_script_setup_true_lang-CzZ7q7yO.js";import{_ as ee}from"./CardDescription.vue_vue_type_script_setup_true_lang-9a1ZITmA.js";import{c as v,a as xe,_ as me}from"./index-DO2Oo4Qc.js";import{_ as ve}from"./CardTitle.vue_vue_type_script_setup_true_lang-CrukT7Rn.js";import{_ as m,u as he,a as we}from"./Skeleton.vue_vue_type_script_setup_true_lang-AnMdgcMV.js";import{C as te}from"./circle-minus-DnoaxAFK.js";import"./NavFooter.vue_vue_type_script_setup_true_lang-sqQJm0cU.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-DzOPT53X.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ye=v("UsersRoundIcon",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),_e=_({__name:"CardFooter",props:{class:{}},setup(f){const x=f;return(h,F)=>(d(),c("div",{"data-slot":"card-footer",class:g(e(xe)("flex items-center px-6 [.border-t]:pt-6",x.class))},[de(h.$slots,"default")],2))}}),Fe={class:"flex items-center space-x-4 w-full min-w-0"},be={class:"space-y-2 w-full"},ke={class:"flex flex-col space-y-3 w-full"},De={class:"space-y-2 w-full"},Se=_({__name:"SkeletonBox",setup(f){return(x,h)=>(d(),c(y,null,[t("div",Fe,[i(e(m),{class:"h-12 w-12 rounded-full shrink-0"}),t("div",be,[i(e(m),{class:"h-4 w-full"}),i(e(m),{class:"h-4 w-5/6"})])]),t("div",ke,[i(e(m),{class:"h-[120px] w-full rounded-xl"}),t("div",De,[i(e(m),{class:"h-4 w-full"}),i(e(m),{class:"h-4 w-5/6"})])])],64))}}),Ce={class:"p-6 space-y-6"},$e={class:"mt-6"},Me={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Re={key:0},qe={key:1},Ve={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ae={key:0},Le={key:1},Pe={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Be={class:"font-bold"},Ne={class:"mb-6"},Ie={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Te={class:"text-[13px] text-gray-500 ml-10"},je={class:"flex items-center gap-2 mb-1"},ze={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-3 mt-6"},Oe={class:"text-gray-500 text-[13px]"},Ue={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ee={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},He={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Qe={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ze={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ke={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ye={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Ge={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},Je={class:"text-gray-500 text-[13px] flex items-center gap-2 mb-2"},We=["href"];function u(f){return`${new Date(f).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}`}const ut=_({__name:"View-File",props:{id:{}},setup(f){const x=f;he();const h=[{title:"View File",href:"/admin/view-file/"+x.id}],F=async()=>(await ue.post("/graphql",{query:`
    query ($id: String!) {
        viewFile(id: $id) {
            file {
                municipalStatus
